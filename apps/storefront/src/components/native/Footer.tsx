...
const data = [
   {
      ...
      links: [
         {
            label: 'Sarung Tangan Medis',
            url: '/products?industry=medical',
         },
         {
            label: 'Sarung Tangan Manufaktur',
            url: '/products?industry=manufacturing',
         },
         {
            label: 'Sarung Tangan Makanan',
            url: '/products?industry=food',
         },
      ],
   },
   {
